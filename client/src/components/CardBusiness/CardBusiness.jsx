...
const CardBusiness = ({ residentName, profileImage, businessImage, reportTitle, description, apartament, date, address, contact }) => {
    return (
        <article className='p-4  bg-base-100 space-y-3 rounded-l-3xl lg:p-6'>
            {<figure><img src={businessImage} alt='Foto producto' /></figure>}
