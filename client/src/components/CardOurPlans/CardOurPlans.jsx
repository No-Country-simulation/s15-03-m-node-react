...
const CardOurPlans = ({ title, lists, scale }) => {
    return (
        <div className={`bg-[#DFE6FF] space-y-6 rounded-lg md:w-72 shadow-lg lg:w-64 ${scale} xl:w-72`}>
            ...
            <div className='pb-4 px-3'>
                <button className='text-[#171925] text-sm font-semibold rounded-md py-2 w-full bg-[#FF9337]'>Comenzar</button>
            </div>
        </div>
    )
}
