...
function Feature2() {
  return (
    ...
    <div className="hero-content flex-col lg:flex-row-reverse">
      <img src="https://img.daisyui.com/images/stock/photo-1414694762283-acccc27bca85.jpg" className="w-2/4 rounded-lg shadow-2xl" />
      <div>
        <h1 className="text-5xl font-bold">Sobre nosotros</h1>
        <p className="py-6">En EdificioManager, nos dedicamos a revolucionar la gestión de edificios y comunidades
