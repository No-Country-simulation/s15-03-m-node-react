...
const OurPlans = () => {
    return (
        <section id='plans' className='py-6 px-3 text-center space-y-3 bg-[#171925] border-b-[#483AE7] border-b-[1rem] lg:pb-12'>
            <div className='lg:w-[90%] mx-auto'>
                <div className='md:w-[75%] md:mx-auto'>
                    <h2 className=' text-3xl pb-2 font-medium text-[#EEF2FF] xl:text-4xl'>Nuestros planes</h2>
