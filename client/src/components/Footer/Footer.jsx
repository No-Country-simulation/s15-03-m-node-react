...
import Logo from "../../assets/footer/Logo-Building.png";
    ...
    <footer className="footer px-3 py-12 bg-[#EEF2FF] border-b-[1rem] border-[#483AE7]">
      <section className=" md:w-[90%] md:mx-auto space-y-6 lg:flex lg:justify-between md:space-y-0">
        ...
        <div className=" text-[#171925] font-medium">
          ...
          <p className="text-xs">
            Estate a atento a las últimas novedades y actuallizaciones de
            nuestra plataforma.
          </p>
          <form className="relative pt-4">
            <input
              className="placeholder:font-semibold p-1 pr-8 placeholder:text-[#171925] outline-none bg-transparent rounded-md border border-[#483AE7]"
              type="email"
              name="email"
              id="email"
              required
