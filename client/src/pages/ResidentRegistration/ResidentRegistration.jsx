  ...
  return (
    <section className="min-h-screen px-3 bg-slate-400 flex items-center ">
      <form
        ...
        className="pb-8 md:w-[90%] md:mx-auto lg:w-[70%] xl:w-[50%]"
      >
        <section className=" py-5 md:flex md:justify-between">
          <div className=" text-center space-y-2 md:text-start md:w-96">
            ...
            <p className=" text-sm">
              Por favor, complete la siguiente información para registrar su
        ...
        <section className="py-2 space-y-2">
          ...
          <div className=" text-sm space-y-3 md:flex md:space-x-6 md:space-y-0">
            <div className=" flex flex-col">
              <label className="text-xs pb-1 font-medium" htmlFor="name">
                Nombre completo
              </label>
              <input
              ...
              />
              <span className="text-xs text-red-600 pb-2 xl:text-sm">
                {errors.name && errors.name.message}
              </span>
            </div>
            <div className=" flex flex-col">
              <label className="text-xs pb-1 font-medium" htmlFor="ID">
            ...
            <div className=" flex flex-col">
              <label className="text-xs pb-1 font-medium" htmlFor="phone">
                Celular
              </label>
              <input
                className=" p-1 outline-none rounded-md border border-gray-500"
        ...
        <section className="py-2 space-y-2">
          ...
          <div className="text-sm space-y-3 md:flex md:space-x-8 items-center md:space-y-0">
            ...
            <div className=" flex flex-col">
              <label className="text-xs pb-1 font-medium" htmlFor="floor">
                Piso (si aplica)
              </label>
              <select
                className="py-2 outline-none rounded-md"
        ...
        <section className="py-2 space-y-2">
          ...
          <div className="text-sm space-y-3 md:flex md:space-x-6 md:space-y-0">
            <div className=" flex flex-col">
              <label className="text-xs pb-1 font-medium" htmlFor="email">
            ...
            <div className=" flex flex-col">
              <label className="text-xs pb-1 font-medium" htmlFor="password">
                Contraseña
              </label>
              <input
                className=" p-1 outline-none rounded-md border border-gray-500"
        ...
        <section className="py-2 flex-col space-x-1">
          <div className=" flex items-center">
            ...
            />
            <label className=" text-xs" htmlFor="privacyPolicy">
